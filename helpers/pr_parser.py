...
_DEPENDABOT_ECOSYSTEM_MAP: dict[str, Literal["pip", "npm", "rubygems"]] = {
    "npm_and_yarn": "npm",
    "pip": "pip",
    "bundler": "rubygems",
}
...
class ParsedPR:
    ...
    old_version: str
    new_version: str
    ecosystem: Literal["pip", "npm", "rubygems"] = "pip"
...
def _detect_ecosystem(package: str, branch: str) -> Literal["pip", "npm", "rubygems"]:
