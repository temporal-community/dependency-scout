...
def get_meta(ecosystem: str) -> EcosystemMeta | None:
    """Return the EcosystemMeta for this ecosystem, or None if unknown."""
    return _get_metadata_registry().get(ecosystem)
